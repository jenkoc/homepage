    ...
    <main className="m-4">
      ...
      <div>
        <div>
          ...
          <br />
          <p>
            Dieses Dokument kann zu Zwecken der Aufbewahrung über den Befehl
            „Drucken“ im Browser ausgedruckt werden.
          </p>
        </div>
        ...
        <div>
          <h5>Arten der erhobenen Daten</h5>

          <p>
            Zu den personenbezogenen Daten, die diese Anwendung selbstständig
            oder durch Dritte verarbeitet, gehören: Tracker; Nutzungsdaten.
          </p>
          ...
          <p>
            ...
            diese Anwendung eingesetzt werden, dient dem Zweck, den vom Nutzer
            gewünschten Dienst zu erbringen, und allen anderen Zwecken, die im
            vorliegenden Dokumentund in der Cookie-Richtlinie beschrieben sind.
          </p>
          <p>
        ...
        <div>
          <h5>Art und Ort der Datenverarbeitung</h5>
          <h5>Verarbeitungsmethoden</h5>
          <p>
            ...
            <br />
            Die Datenverarbeitung wird mittels Computern oder IT-basierten
            Systemen nach organisatorischen Verfahren und Verfahrensweisen
            durchgeführt, die gezielt auf die angegebenen Zwecke abstellen.
            Zusätzlich zum Verantwortlichen könnten auch andere Personen intern
        ...
        <div>
          ...
          <p>
            ...
            Verpflichtungen nachkommen, auf Durchsetzungsforderungen reagieren,
            seine Rechte und Interessen (oder die der Nutzer oder Dritter)
            schützen, böswillige oder betrügerische Aktivitäten aufdecken kann.
            Darüber hinaus werden Daten zu folgenden Zwecken erhoben: Analytik.
          </p>

          <p>
            Nutzer können im Abschnitt “Ausführliche Angaben über die
            Verarbeitung personenbezogener Daten” dieses Dokuments weitere
            detaillierte Informationen zu diesen Verarbeitungszwecken und die zu
            den für den jeweiligen Zweck verwendeten personenbezogenen Daten
            vorfinden.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Personenbezogene Daten werden zu folgenden Zwecken unter
            Inanspruchnahme folgender Dienstleistungen erhoben:
          </p>
          <ul>
            <li>
              <div>
        ...
        <h5>Weitere Informationen für Nutzer</h5>
        ...
        <h5>Weitere Informationen zur Verweildauer</h5>
        ...
        <h5 id="rights_subjects">Die Rechte der Nutzer</h5>
        <p>
        ...
        <h5>Details zum Widerspruchsrecht bezüglich der Verarbeitung</h5>
        <p>
          <strong>
        ...
        <h5>Wie die Rechte ausgeübt werden können</h5>
        <p>
        ...
        <div>
          ...
          <p>
            ...
            ordnungsgemäß genutzt wurden.
            <br />
            Der Nutzer erklärt, sich dessen bewusst zu sein, dass der Anbieter
            von den Behörden zur Herausgabe von personenbezogenen Daten
          ...
          <h5>Systemprotokolle und Wartung</h5>
          <p>
          ...
          <h5>Nicht in dieser Datenschutzerklärung enthaltene Informationen</h5>
          <p>
          ...
          <h5>Änderungen dieser Datenschutzerklärung</h5>
          <p>
...
[Full Name]
[Address as above or differently if needed]
...
The content and works on these pages created by the site operators are subject to [Your Country]'s copyright law. Duplication, processing, distribution, or any form of commercialization of such material beyond the scope of the copyright law shall require the prior written consent of its respective author or creator. */
